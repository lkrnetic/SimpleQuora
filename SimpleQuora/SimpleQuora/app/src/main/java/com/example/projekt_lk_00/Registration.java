...
public class Registration extends AppCompatActivity {
    String username, password, password2, id;
    EditText et_username, et_password, et_password2;
    private Greska err = new Greska();
    private User user;
    private Context con;
    private String wsUrl = "https://www.racunalna-znanost.com.hr/pod_luka/question/users.php/registration";
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        et_password2 = findViewById(R.id.et_password_potvrdi);
        con = this;
    }
    ...
    private static class WSPregledHelper extends AsyncTask<String, Void, User> {
        ...
        protected void onPostExecute(User user){
            ...
            if (user != null) {
                ...
                Log.d("id",""+ user.getId());
                if(user.getId() == -1) {
                    Toast.makeText(activity, "Korisničko ime koje ste unijeli već postoji!", Toast.LENGTH_LONG).show();
                }
                else {
                    ...
                    Toast.makeText(activity, "Korisnički račun je uspješno stvoren! Dobrodošli " + user.getUsername(), Toast.LENGTH_LONG).show();
                }
                /*
                if (tid == 0){
                    activity.id.setText("");
